...
# Random Sobol sampling / qParEGO (Pareto Efficient Global Optimisation) / MOBO-RS (Random Scalar) / qEHVI (parallel expected hypervolume improvement) / qNEHVI (parallel noisy expected hypervolume improvement)
    # https://ojs.aaai.org/index.php/AAAI/article/view/6561
